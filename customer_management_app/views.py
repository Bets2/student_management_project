...
def doRegistration(request):
    ...
    if user_type is None:
        messages.error(
            request, "Please use valid format for the email id: '<username>.<staff|customer|hod>@<domain>'")
        return render(request, 'registration.html')
    ...
    elif user_type == CustomUser.CUSTOMER:
        Customers.objects.create(admin=user)
...
def get_user_type_from_email(email_id):
    ...
    '<username>.<staff|customer|hod>@<college_domain>'
